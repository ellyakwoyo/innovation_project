...
class User
{
	...
	public function createUserAccount($username, $email, $password, $usertype){
		//To protect application from sql attack, i used prepared statement
...
//$user = new User();
//echo $user -> createUserAccount("Kaundi", "ev@gmail1.com", "elly1234", "Admin");

//echo $user -> userLogin( "elida@gmail.com", "1234Elly");
//echo $row["usertype"];
