							...
							<div class="card">
						      <div class="card-body">
						        <h5 class="card-title">Shoe Confirmation</h5>
						          <p class="card-text">Here customers will enter shoe serial number to confirm its legitimacy</p>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="card">
					...
					<p class="card-text">Here admin can add new shoes, and manage existing ones</p>
				    <a href="#" data-bs-toggle="modal" data-bs-target="#form_manage_shoes"  class="btn btn-primary">Add</a>
				    <a href="manageShoes.php" class="btn btn-primary">Manage</a>
				    </div>
				</div>
			...
			<div class="col-md-4">
				<div class="card">
					<div class="card-body" style="width: 20rem;">
					<h5 class="card-title">Aministrators</h5>
					<p class="card-text">Here adminstrator will be able to add new administrators or delete the existing administrator accounts.</p>
			...
			<div class="col-md-4">
				<div class="card">
					...
					<p class="card-text">Here admnistrator will be able to check the complains from the users.</p>
